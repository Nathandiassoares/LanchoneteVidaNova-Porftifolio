...
const titulo = document.querySelector('.pedido__titulo')


let test = itens.map((Element)=> {
  return `
  ...
  <section class="pedido__caracteristicas">
    ...
    <p class="pedido__descricao">Valor: ${Element.valorDoLanche},00R$</p>
...
document.querySelector(".pedido__separado").innerHTML = test.join("");
...
// const pedido = document.querySelector('.pedido__item')
